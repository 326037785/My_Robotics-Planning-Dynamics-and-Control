...
% X轴：红色 ('r')
X = plot3([orgX, orgX+Trans(1,1)], [orgY, orgY+Trans(2,1)], [orgZ, orgZ+Trans(3,1)], 'r', 'LineWidth', 2);
hold on
grid on

% Y轴：绿色 ('g')
Y = plot3([orgX, orgX+Trans(1,2)], [orgY, orgY+Trans(2,2)], [orgZ, orgZ+Trans(3,2)], 'g', 'LineWidth', 2);

% Z轴：蓝色 ('b')
Z = plot3([orgX, orgX+Trans(1,3)], [orgY, orgY+Trans(2,3)], [orgZ, orgZ+Trans(3,3)], 'b', 'LineWidth', 2);
